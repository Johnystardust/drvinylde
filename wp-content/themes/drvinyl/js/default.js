$(document).ready(function() {
	...
	$(".spot").click(function(e) {
		...
		$(".spot."+place).addClass("spot-active");
		$(".servicepoints").hide();
		$(".service-"+place).show();
	...
	$("#slideshow .slideshow-image").hide();
	$("#slideshow .slideshow-image:first").fadeIn(200);
	
	$(".toggle-slideshow").click(function(e) {
	...
	function set_offerte_form(branche) {
	
		new_html = '';
		
		$("#offerte_onderdeel").html("");
		
		switch(branche) {
		
			case "Automotive":
				new_html += "<option value='Interieur'>Interieur</option>";
				new_html += "<option value='Dashboard'>Dashboard</option>";
				new_html += "<option value='Stuurwiel'>Stuurwiel</option>";
				new_html += "<option value='Interieurreparaties'>Interieurreparaties</option>";
				new_html += "<option value='Geurverwijdering'>Geurverwijdering</option>";
				new_html += "<option value='Exterieur'>Exterieur</option>";
				new_html += "<option value='Spotrepair'>Spotrepair</option>";
				new_html += "<option value='Steenslag Camouflage'>Steenslag Camouflage</option>";
				new_html += "<option value='Uitdeuken zonder spuiten'>Uitdeuken zonder spuiten</option>";
				break;
		
			case "Bouwsector":
				new_html += "<option value='Kunststof kozijnen'>Kunststof kozijnen</option>";
				new_html += "<option value='Aluminium kozijnen'>Aluminium kozijnen</option>";
				new_html += "<option value='Oppervlakte schadeherstel'>Oppervlakte schadeherstel</option>";
				break;
		
			case "Openbaar vervoer":
				new_html += "<option value='Interieur herstel'>Interieur herstel</option>";
				new_html += "<option value='Exterieur herstel'>Exterieur herstel</option>";
				new_html += "<option value='Oppervlakte schadeherstel'>Oppervlakte schadeherstel</option>";
				break;
			...
			case "Overig":
				new_html += "<option value='Algemeen'>Algemeen</option>";
				break;
		}
		
		$("#offerte_onderdeel").html(new_html);
	
	}
						
	$("#offerte_branche_trigger").change(function() {
	
		set_offerte_form($(this).val());
